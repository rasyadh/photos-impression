...
# for machine learning we use 2 data directly
...
# treated as labeled dataset, unsuperviesd feature extraction / dimensionality reduction
n_components = 150
